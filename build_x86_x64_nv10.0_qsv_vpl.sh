...
export PKG_CONFIG_PATH=/i/github/FFmpeg/third/libx264-x64/lib/pkgconfig:/i/github/FFmpeg/third/nv-sdk-v10.0/lib/pkgconfig:/i/github/FFmpeg/third/libvpl-msvc-x64/lib/pkgconfig:$PKG_CONFIG_PATH
echo $PKG_CONFIG_PATH

./configure --prefix=/f/ff/usr/ffmpeg-6.0/x86_x64/nv-10.0-qsv-vpl \
			--enable-shared \
			--disable-static \
    		--enable-gpl \
    		--enable-libx264 \
